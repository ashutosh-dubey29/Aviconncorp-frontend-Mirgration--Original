...
import { Highcharts, loadModules, loadCommonModules, initModules } from '../shared/highcharts-wrapper';
...
export class WhMeteringComponent implements OnInit {
    ...
    constructor(private dashData: DashboardDataService,
        ...
        (async () => {
                try {
                    // Centralized loader: returns the unwrapped module initializer functions
                    this.hcModules = await loadCommonModules();
                } catch (e) {
                    // ignore failures during tests or in restricted environments
                    this.hcModules = [];
                }
        })();
