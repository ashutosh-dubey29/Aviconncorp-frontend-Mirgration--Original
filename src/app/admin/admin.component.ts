...
import { Highcharts, loadModules, initModules } from '../shared/highcharts-wrapper';
...
export class AdminComponent implements OnInit {
  ...
  constructor(private UserService:UserService,private dataService:DataService, private fb:UntypedFormBuilder, private album:MovieService) { 
    ...
    (async () => {
      try {
        const modules = await loadModules(['highcharts/es-modules/masters/modules/solid-gauge.src.js']);
        initModules(Highcharts as any, modules);
      } catch (e) {
